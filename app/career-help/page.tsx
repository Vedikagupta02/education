...
export default function CareerHelpPage() {
  ...
  const [advice, setAdvice] = useState<CareerAdvice | string>('');
        ...
        <div style={{
          ...
          <div style={{
            ...
            {typeof advice === 'object' ? (
              <>
                {advice.career_outlook && (
                  <div>
                    <h3 style={{ fontSize: '1.25rem', fontWeight: 600, marginBottom: '0.5rem' }}>Career Outlook</h3>
                    <p>{advice.career_outlook}</p>
                  </div>
                )}
                {advice.career_paths && (
                  <div>
                    <h3 style={{ fontSize: '1.25rem', fontWeight: 600, marginBottom: '0.5rem' }}>Career Paths</h3>
                    <p>{advice.career_paths}</p>
                  </div>
                )}
              </>
            ) : (
